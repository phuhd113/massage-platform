...
public class SearchBoostTests(PostgresFixture fixture)
{
    ...
    public async Task Campaign_đã_huỷ_mất_boost_ngay_lập_tức()
    {
        ...
        var before = await new SearchService(fixture.CreateContext(), new FakeAnalyticsQueue(), TestMedia.Urls)
            .SearchAsync(await InAreaAsync(area));
        ...
        var after = await new SearchService(fixture.CreateContext(), new FakeAnalyticsQueue(), TestMedia.Urls)
            .SearchAsync(await InAreaAsync(area));
    ...
    public async Task Boost_mua_ở_tỉnh_này_không_ăn_sang_tỉnh_trùng_tên_quận()
    {
        ...
        var ởTỉnhKhác = await new SearchService(fixture.CreateContext(), new FakeAnalyticsQueue(), TestMedia.Urls)
        ...
        var ởTỉnhMua = await new SearchService(fixture.CreateContext(), new FakeAnalyticsQueue(), TestMedia.Urls)
            .SearchAsync(new SearchQueryDto(
    ...
    public async Task Boost_mua_ở_quận_không_ăn_sang_trang_tỉnh()
    {
        ...
        var trangTỉnh = await new SearchService(fixture.CreateContext(), new FakeAnalyticsQueue(), TestMedia.Urls)
