 ...
 * URL tiếng Việt**.
 *
 * Cơ chế là `rewrite`, không phải `redirect`: `/massage-tai-nha/quan-7` được xử lý
 * nội bộ như `/vi/massage-tai-nha/quan-7`, còn thanh địa chỉ, canonical và mọi thứ
 ...
 * vào `/massage-tai-nha/quan-7` từ Google **luôn** nhận tiếng Việt tại đúng URL đó,
